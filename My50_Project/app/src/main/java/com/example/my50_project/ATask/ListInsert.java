...
public class ListInsert extends AsyncTask<Void, Void, String> {
    ...
    String id, name, date, imagedbpath, imagerealpath;

    public ListInsert(String id, String name, String date, String imagedbpath, String imagerealpath) {
        this.id = id;
        this.name = name;
        this.date = date;
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/app/anInsertMulti";
